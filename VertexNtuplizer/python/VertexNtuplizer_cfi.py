...
vertexNtuplizer = cms.EDAnalyzer("VertexNtuplizer",
  ...
  trackT0FromBS                   = cms.untracked.InputTag("tofPID",                                   "t0",                  "BTV"),
  trackSigmaT0FromBS              = cms.untracked.InputTag("tofPID",                                   "sigmat0",             "BTV"),
  # trackQualityFromBS              = cms.untracked.InputTag("mtdTrackQualityMVA",                       "mtdQualMVA",          "BTV"),
  trackT0FromPV                   = cms.untracked.InputTag("tofPIDFromPV",                             "t0",                  "BTV"),
  trackSigmaT0FromPV              = cms.untracked.InputTag("tofPIDFromPV",                             "sigmat0",             "BTV"),
  # trackQualityFromPV              = cms.untracked.InputTag("mtdTrackQualityMVAFromPV",               "mtdQualMVA",          "BTV"), # Doesn't exist right now
