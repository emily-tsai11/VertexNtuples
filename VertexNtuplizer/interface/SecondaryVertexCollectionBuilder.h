...
class SecondaryVertexCollectionBuilder {
  ...
  public:
    ...
    SecondaryVertexCollection getSecVerticesInclusiveMTDBS() { return secVerticesInclusiveMTDBS_; }
    ...
    SecondaryVertexCollection getSecVerticesSlimmedMTDBS() { return secVerticesSlimmedMTDBS_; }
  ...
  private:
    ...
    SecondaryVertexCollection secVerticesInclusiveMTDBS_;
    SecondaryVertexCollection secVerticesInclusiveMTDPV_;
    SecondaryVertexCollection secVerticesSlimmed_;
    SecondaryVertexCollection secVerticesSlimmedMTDBS_;
    ...
    reco::VertexCompositePtrCandidateCollection mergedSecondaryVertices_; // Gives timing information for slimmed SVs bc the collections are linked
    ...
    edm::ValueMap<float> trackT0FromBS_;
    edm::ValueMap<float> trackSigmaT0FromBS_;
    // edm::ValueMap<float> trackQualityFromBS_;
